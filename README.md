...
- Develop end-to-end pipelines for agricultural and automated systems  
- Deploy AI on edge devices (Jetson, ARM, microcontrollers)  
- Work with **LLMs, multimodal models, and agentic AI**  
- Improve model efficiency and integrate AI into production systems  

### 💻 Areas of Interest
- AI, Machine Learning & Deep Learning
- Computer Vision for agriculture, environment, and real-world systems
- LLMs, multimodal models, and agentic AI workflows
